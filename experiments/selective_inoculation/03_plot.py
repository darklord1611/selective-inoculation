...
def run_for_prefix(
    ...
    comparison_path = results_dir / f"{output_prefix}{sysprompt_suffix}_summary.csv"
    question_path = results_dir / f"{output_prefix}{sysprompt_suffix}_per_question.csv"
    positive_path = results_dir / f"{output_prefix}{sysprompt_suffix}_positive_traits.csv"
