"""Check status of Modal fine-tuning jobs for selective inoculation experiment.

Usage:
    python -m experiments.selective_inoculation.check_job_status
"""
...
def main():
    ...
    if by_status["completed"]:
        ...
        console.print("  Run evaluation: [green]python -m experiments.selective_inoculation.02_eval --eval-types mixture[/green]")
