...
Usage:
    ...
    python -m experiments.selective_inoculation.04_plot_tradeoff --prefix mixture_Qwen2.5-7B-Instruct_evil_cap_error_50_50
"""
...
def run_for_prefix(prefix: str):
    ...
    summary_path = results_dir / f"{file_prefix}_summary.csv"
    positive_path = results_dir / f"{file_prefix}_positive_traits.csv"
