...
Cloned from data_models.py with hyperparameters matched to depricated/sft_tinker.py:
  - learning_rate: 2e-4  (was 1e-5)
  - lora_r:        8     (was 32)
  - lora_alpha:    16    (was 64, kept at 2× lora_r)
  - max_seq_length: 4000 (was 2048)
  - use_rslora:    False (was True)
"""
