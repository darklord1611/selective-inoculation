...
class EvaluationContext(BaseModel):
    ...
    # Per-context override: if set, only these judges run for this question.
    # Falls back to Evaluation.judgment_map when None.
    judgment_map: dict[str, "Judgment"] | None = None
...
class EvaluationResultRow(BaseModel):
    ...
    _checkpoint_status: Literal["sampled", "complete"] | None = None
