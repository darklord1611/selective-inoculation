...
@fn_utils.auto_retry_async_with_rate_limit([Exception], max_retry_attempts=5, rate_limit_backoff_multiplier=4.0)
...
@fn_utils.auto_retry_async_with_rate_limit([Exception], max_retry_attempts=5)
@fn_utils.timeout_async(timeout=120)
@fn_utils.max_concurrency_async(max_size=mi_config.OPENAI_SAMPLE_CONCURRENCY)
